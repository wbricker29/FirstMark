...
- [Blocking Item 1] — link to `spec/units/###-slug/plan.md` and evidence report
- [Blocking Item 2] — link to `spec/units/###-slug/plan.md` and evidence report
-->
...
|-----|--------------|------------------|--------------------|---------------|
| 012 | Example      | 47% (state.json) | ✅ Yes             | spec/units/012-example/ |
-->
...
L1 (Project-Level):
- `spec/PRD.md` (this doc)
- `spec/spec.md`

L2 (Feature-Level):
- `spec/units/###-slug/design.md`
- `spec/units/###-slug/plan.md`
