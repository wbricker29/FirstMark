...
from typing import TYPE_CHECKING, Any, Callable, TypedDict, Union, Literal, TypeAlias
...
{str(additional_args)}."""
        ...
        steps = list(
            self._run_stream(task=self.task, max_steps=max_steps, images=images)
        )
    ...
    ) -> Generator[ChatMessageStreamDelta | ActionOutput | ToolOutput]:
        """
