        ...
        if stream_delta.tool_calls:
            for tool_call_delta in (
                ...
                if tool_call_delta.index is not None:
                    ...
                    raise ValueError(
                        f"Any call index is not provided in tool delta: {tool_call_delta}"
                    )
...
class MLXModel(Model):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.load_kwargs.setdefault("tokenizer_config", {}).setdefault(
    ...
    def generate(
        ...
        **kwargs,
        ...
        prompt_ids = self.tokenizer.apply_chat_template(
            messages, tools=tools, **self.apply_chat_template_kwargs
        )
...
class TransformersModel(Model):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            flatten_messages_as_text=not self._is_vlm, model_id=model_id, **kwargs
        )
    ...
    def _prepare_completion_args(
        ...
        **kwargs,
        ...
        model_tokenizer = (
            self.processor.tokenizer if hasattr(self, "processor") else self.tokenizer
        )
        stopping_criteria = (
    ...
    def generate(
        ...
        **kwargs,
        ...
        if response_format is not None:
            raise ValueError(
                "Transformers does not support structured outputs, use VLLMModel for this."
            )
    ...
    def generate_stream(
        ...
        **kwargs,
        ...
        thread = Thread(
            ...
            kwargs={"streamer": self.streamer, **generation_kwargs},
        )
        thread.start()
        ...
        for new_text in self.streamer:
            ...
            yield ChatMessageStreamDelta(
                ...
                tool_calls=None,
                token_usage=TokenUsage(
                    input_tokens=count_prompt_tokens, output_tokens=1
                ),
            )
        thread.join()
