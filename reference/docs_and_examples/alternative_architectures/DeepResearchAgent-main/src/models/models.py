...
class ModelManager(metaclass=Singleton):
        ...
        if use_local_proxy:
            ...
            client = AsyncOpenAI(
                ...
                base_url=self._check_local_api_base(
                    local_api_base_name="SKYWORK_AZURE_US_API_BASE",
            ...
            model = RestfulTranscribeModel(
                api_base=self._check_local_api_base(
                    local_api_base_name="SKYWORK_AZURE_BJ_API_BASE",
                    remote_api_base_name="OPENAI_API_BASE",
                ),
                api_key=api_key,
                api_type="whisper",
            ...
            model = RestfulResponseModel(
                api_base=self._check_local_api_base(
                    local_api_base_name="SKYWORK_SHUBIAOBIAO_API_BASE",
                    remote_api_base_name="OPENAI_API_BASE",
                ),
                api_key=api_key,
                api_type="responses",
    ...
    def _register_google_models(self, use_local_proxy: bool = False):
        if use_local_proxy:
            ...
            client = AsyncOpenAI(
                api_key=api_key,
                base_url=self._check_local_api_base(
                    local_api_base_name="SKYWORK_OPENROUTER_BJ_API_BASE",
    ...
    def _register_deepseek_models(self, use_local_proxy: bool = False):
        ...
        if use_local_proxy:
            ...
            api_base = self._check_local_api_base(
                local_api_base_name="SKYWORK_DEEPSEEK_API_BASE",
