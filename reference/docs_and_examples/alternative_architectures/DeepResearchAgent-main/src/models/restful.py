...
class RestfulResponseClient:
    ...
    def completion(self, model, input, tools, **kwargs):
        headers = {"app_key": self.api_key, "Content-Type": "application/json"}
        ...
        for line in response_text.split("\n"):
            if line.strip():
                try:
                    ...
                    if (
                        json_line.startswith("data: ")
                        and "response.completed" in json_line
                    ):
...
class RestfulTranscribeClient:
    ...
    def completion(self, model, file_stream, **kwargs):
        files = {"file": file_stream}
        headers = {
            "app_key": self.api_key,
        }
        response = requests.post(
            f"{self.api_base}/{self.api_type}", headers=headers, files=files
        )
...
class RestfulImagenClient:
    ...
    def completion(self, model, prompt: str, **kwargs):
        headers = {"app_key": self.api_key, "Content-Type": "application/json"}
...
class RestfulVeoPredictClient:
    ...
    def completion(self, model, prompt: str, image: str = None, **kwargs):
        headers = {"app_key": self.api_key, "Content-Type": "application/json"}
...
class RestfulVeoFetchClient:
    ...
    def completion(self, model, name: str, **kwargs):
        headers = {"app_key": self.api_key, "Content-Type": "application/json"}
...
class RestfulModel(ApiModel):
    ...
    def generate_stream(
        ...
        **kwargs,
        ...
        for event in self.client.completion(
...
class RestfulTranscribeModel(ApiModel):
    ...
    def create_client(self):
        return RestfulTranscribeClient(
            api_base=self.api_base,
            api_key=self.api_key,
            api_type=self.api_type,
            model_id=self.model_id,
...
class RestfulVeoPridictModel(ApiModel):
    ...
    def create_client(self):
        return RestfulVeoPredictClient(
            api_base=self.api_base,
            api_key=self.api_key,
            api_type=self.api_type,
            model_id=self.model_id,
    ...
    def generate(
        ...
        **kwargs,
        ...
        """
        logger.info(
            f"Generating with model {self.model_id} using prompt: {prompt} and image: {image}, please wait..."
        )
        response = self.client.completion(
            model=self.model_id,
            prompt=prompt,
...
class RestfulVeoFetchModel(ApiModel):
    ...
    def generate(
        ...
        **kwargs,
        ...
        """
        logger.info(
            f"Fetching with model {self.model_id} using name: {name}, please wait..."
        )
        response = self.client.completion(
            model=self.model_id,
            name=name,
